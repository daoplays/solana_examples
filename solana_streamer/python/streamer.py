...
current_block = None
if (current_row_id_to_insert > 0):
    last_row = get_db_row(conn, current_row_id_to_insert - 1)
    print("getting current_block from DB: ")
    print(last_row)
    current_block = last_row[0][1]
